...
##### 1. Setting the data path accordingly we use main.py to train baseline AWD_LSTM model, and type model. 
...
#### 7. The the code corpus can be found at (https://drive.google.com/drive/folders/1DJev2PwKBAPlUMy-OsT4kKVlTM1Mj_XN?usp=sharing). Although We report basic LSTM performance in the paper running the AWD_LSTM model on this dataset should give better result. 
