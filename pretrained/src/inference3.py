...
if args.bptt==1:
    dsize = 1000
    test_data = test_data[1:dsize]
    test_data2 = test_data2[1:dsize]
    test_data_type = test_data_type[1:10]
###############################################################################
# debug mode the model
###############################################################################
...
# test_loss, test_loss2, test_loss_cb = evaluate_both(test_data[:1000], test_data_type[:1000] ,test_data2[:1000], test_batch_size)
print('=' * 165)
